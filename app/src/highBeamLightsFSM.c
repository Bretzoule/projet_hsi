...
/*!
 *  \def ST_HIGHBEAM_LIGHTS_OFF
 *  \brief Manages state of the lights when it's off
 */
#define ST_HIGHBEAM_LIGHTS_OFF 0

/*!
 *  \def ST_HIGHBEAM_LIGHTS_ON
 *  \brief Manages state of the low beam lights when it's on
 */
#define ST_HIGHBEAM_LIGHTS_ON 1

/*!
 *  \def ST_HIGHBEAM_ACQ
 *  \brief Manages state of the acq light
 */
#define ST_HIGHBEAM_ACQ 3

/*!
 *  \def EV_TURN_HIGHBEAM_LIGHTS_OFF
 *  \brief Event status when the lights turn off
 */
#define EV_TURN_HIGHBEAM_LIGHTS_OFF 0

/*!
 *  \def EV_TURN_HIGHBEAM_LIGHTS_ON
 *  \brief Event status when the lights turn on
 */
#define EV_TURN_HIGHBEAM_LIGHTS_ON 1

/*!
 *  \def EV_ACQ_HIGHBEAM_RECEIVED
...
static int highBeamLightsOff(void);
static int highBeamLightsOn(void);
static int fsmError(void);
static int notifyListeners(void);

/* Transitions */
tTransition trans[] = {
    {ST_HIGHBEAM_LIGHTS_OFF, EV_TURN_HIGHBEAM_LIGHTS_ON, &highBeamLightsOn, ST_HIGHBEAM_LIGHTS_ON},
    {ST_HIGHBEAM_LIGHTS_OFF, EV_TURN_HIGHBEAM_LIGHTS_OFF, NULL, ST_HIGHBEAM_LIGHTS_OFF},
    {ST_HIGHBEAM_LIGHTS_ON, EV_TURN_HIGHBEAM_LIGHTS_ON, NULL, ST_HIGHBEAM_LIGHTS_ON},
    {ST_HIGHBEAM_LIGHTS_ON, EV_TURN_HIGHBEAM_LIGHTS_OFF, &highBeamLightsOff, ST_HIGHBEAM_LIGHTS_OFF},
    {ST_HIGHBEAM_LIGHTS_ON, EV_NONE, &fsmError, ST_ERROR},
    {ST_HIGHBEAM_LIGHTS_ON, EV_ACQ_HIGHBEAM_RECEIVED, &notifyListeners, ST_HIGHBEAM_ACQ},
    {ST_HIGHBEAM_ACQ, EV_TURN_HIGHBEAM_LIGHTS_OFF, &highBeamLightsOff, ST_HIGHBEAM_LIGHTS_OFF},
    {ST_HIGHBEAM_ACQ, EV_TURN_HIGHBEAM_LIGHTS_ON, NULL, ST_HIGHBEAM_ACQ}};
...
int highBeamLightsFSM(void)
{
    ...
    int ret = 0;
    int event = EV_NONE;
    int state = ST_HIGHBEAM_LIGHTS_OFF;
